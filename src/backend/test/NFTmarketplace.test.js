...
describe("NFTMarketplace", function () {
  ...
  describe("Makeng marketplace items", function(){
    beforeEach(async function(){
      // addr1 mints an nft
      await nft.connect(addr1).mint(URI)
  ...
  describe("Puchasing marketplace items", function(){
    let price=2
    let totalPriceInWei;
    beforeEach(async function(){
      // addr1 mints an nft
    ...
    it("Should fail for invalid item ids, sold items and when not enough ether is paid", async function(){
      ...
      ).to.be.revertedWith("not enough ether cover item price and markget fee")
    });
  })
});
